...
- recall_lab_brief_window_2: min 0.80, max 1.00, mean 0.96
...
- 4/5  Which city did I ship to right before my current one?
...
Split verdicts:
- run 2, sliding_window_2: "Where should you ship my order now?" votes: honest_gap, honest_gap, drifted
